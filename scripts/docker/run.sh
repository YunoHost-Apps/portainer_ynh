...
[ "$architecture" == "amd64" ] && image=portainer/portainer:1.19.2
[ "$architecture" == "i386" ]  && image=portainer/portainer:linux-386-1.19.2
[ "$architecture" == "armhf" ] && image=portainer/portainer:linux-arm-1.19.2
